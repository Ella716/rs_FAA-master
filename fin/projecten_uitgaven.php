...
<div class="header">
  ...
  <div class="main-content">
    <div class="title"> Uitgaven per project.</div>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            ...
            $query = "
                        select project.project_naam, taak.taak_naam, sum(exacte.prijs), exacte.datum
                        from project, taak, exacte
                        where
                        project.project_id=taak.project_id and taak.taak_id=exacte.taak_id group by project.project_naam
                        ";
